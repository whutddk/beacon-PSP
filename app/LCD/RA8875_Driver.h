...
#define LCD_RS_0  LPLD_GPIO_Output_b(PTC, 14, 0)
#define LCD_RS_1  LPLD_GPIO_Output_b(PTC, 14, 1)

#define LCD_CS_0  LPLD_GPIO_Output_b(PTC, 13, 0)
#define LCD_CS_1  LPLD_GPIO_Output_b(PTC, 13, 1)

#define LCD_WR_0  LPLD_GPIO_Output_b(PTC, 15, 0)
#define LCD_WR_1  LPLD_GPIO_Output_b(PTC, 15, 1)

#define LCD_RD_0  LPLD_GPIO_Output_b(PTC, 16, 0)
#define LCD_RD_1  LPLD_GPIO_Output_b(PTC, 16, 1)

#define LCD_REST_0 LPLD_GPIO_Output_b(PTC, 17, 0)
#define LCD_REST_1 LPLD_GPIO_Output_b(PTC, 17, 1)
...
void Show_word(uint16 WOD);
void Show_WD(char *str,uint8 n);
//void RA8875_WAITSTATUS(void);
//uint16 Get_X_ADC_Value_10bit(void);
//uint16 Get_Y_ADC_Value_10bit(void);
void delaysometime(void);
void LcdPrintHz(uint16 code,uint16 x,uint16 y,uint16 color,uint16 bcolor);
void LcdPrintStr(char *str,uint16 x,uint16 y,uint16 color,uint16 bcolor,uint8 mode);
void LcdPrintWord(uint16 *str,uint16 x,uint16 y,uint16 color,uint16 bcolor,uint8 mode);
void LcdPrintf(uint16 x,uint16 y,uint16 color,uint16 bcolor,char *fmt,...);
void LcdPrint16bitBmp(uint16* image,uint16 x,uint16 y,uint16 widht,uint16 height);
void LcdPrint8bitBmp(const uint8* image,uint16 x,uint16 y,uint16 widht,uint16 height);
